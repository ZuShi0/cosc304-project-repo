...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Playstation 5', 1, 'Base Disc Model',629.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Nike AIR jordan 1 Retro High OG', 2,'Hyper Royal Model',119.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Geforce RTX 3090',3,'ASUS ROG Strix Model',1499.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Xbox Series X',1,'1 TB Base Model',599.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Nintendo Switch',1,'Base Neon Red/Blue Model',379.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Fortnite Balenciaga Sweater',2,'Color - Black',1450.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Toilet Paper',4,'Charmaine Ultra Strong 24 Pack',8.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Chicken',4,'2kg Frozen Chicken Breast',10.50);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Milk',4,'4L Dairyland 2%',2.50);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Eggs',4,'18 Extra Large Eggs',4.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Geforce RTX 3060',3,'ROG Strix 12GB Model',329.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Geforce RTX 3070',3,'ROG Strix 8GB Model',499.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Geforce RTX 3080',3,'ROG Strix 10GB Model',699.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Geforce RTX 3060 Ti',3,'ROG Strix 8GB Model',399.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Geforce RTX 3070 Ti',3,'ROG Strix 8GB Model',599.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Geforce RTX 3080 Ti',3,'ROG Strix 12GB Model',1199.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Bread',4,'Loaf of Whole Wheat Wonderbread',2.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Yeast',4,'Fleischmann''s Traditional Yeast',9.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Oculus Quest 2',1,'Base 128GB Model',399.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Yeezy Boost 350 V2',2,'Color - Light',349.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Nike Air Force 1 Low',2,'All White 07 Model',129.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('PlayStation 5 Controller',1,'DualSense Wireless White Model',59.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Nintendo 64 Controller',1,'Wireless Model',64.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Razer Zephyr',3,'RGB Smart Mask',99.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('AMD Radeon RX 6900',3,'ASUS TUF 16GB Model',1884.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Jordan 11 Retro',2,'2021 Cool Grey Model',289.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Yeezy Foam RNNR',2,'Color - Ochre',249.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Fear of God Essentials Hoodie',2,'Color - Black',199.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Chicken Noodle Soup',4,'12 Cans of Campbell''s soup',9.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Xbox One Elite Controller',1,'Wireless Model',199.99);
...
UPDATE Product SET productImageURL = 'img/20.gif' WHERE ProductId = 20;
UPDATE Product SET productImageURL = 'img/21.gif' WHERE ProductId = 21;
